...
class DataProcessor:
    ...
    def balance_data(self , df):
        try:
            ...
            logger.info('Data is successfully balanced')

            return balanced_df

        except Exception as e:
            logger.error(f'Errot during balancing data step {e}')
    ...
    def select_features(self , df):
        try:
            ...
            logger.info(f'Features selcted : {top_10_features}')

            logger.info('Feature selection step successfully completed')

            return top_10_df
        
        except Exception as e:
          logger.error(f'Error during feature selection step {e}')
          raise CustomException('Error while selecting data features' , e)
    ...
    def process(self):
        try:
            ...
            logger.info('Data processeing successfully completed')

        except Exception as e:
          logger.error(f'Error during data preprocessing pipeline {e}')
          raise CustomException('Error while running the data preprocessing pipeline' , e)
